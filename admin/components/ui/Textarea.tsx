    ...
    return (
      <div className="flex flex-col gap-1.5">
        ...
        <textarea
          ...
          id={inputId}
          className={cn(
            "w-full rounded-lg border bg-[var(--admin-bg-field)] px-3 py-2 text-sm text-[var(--admin-fg-base)] placeholder:text-[var(--admin-fg-muted)] transition-colors min-h-[80px] resize-y",
